      ...
      for(String type : this.type.split(";"))
      {
        ...
        switch(Integer.parseInt(type))
        {
              ...
              switch(statId1)
              {
                case 110://Vie.
                  ...
                  if(player.getCurPdv()+val>player.getMaxPdv())
                    val=(long) (player.getMaxPdv()-player.getCurPdv());
          ...
          case 8://D�sapprendre un sort � un percepteur.
      	  ...
      	  {
      		  player.sendMessage("Vous ne poss�de pas de guilde"); 
      		return;  
      	  }
          ...
          case 13://Apprendre une �mote.
            ...
            {
              SocketManager.GAME_SEND_MESSAGE(player,"Vous connaissez d�j� cet emote.");
              return;
            }
          ...
          case 22://Poser un prisme.
            ...
            {
              SocketManager.GAME_SEND_MESSAGE(player,"Vous n'avez pas l'alignement n�cessaire pour placer un prisme.");
              return;
            }
            if(!player.is_showWings())
            {
              SocketManager.GAME_SEND_MESSAGE(player,"Vos ailes doivent �tre activ�es avant de placer un prisme.");
              return;
            }
          ...
          case 33: {
		        ...
		        SocketManager.GAME_SEND_MESSAGE(player,"Votre dragodinde a et� transforme on cam�l�one");
				break;
			}
