    ...
    case CLASS_FECA:
      ...
      case CLASS_ENUTROF:
    	  if(lvl >= 1)
      	{
      		...
      		perso.learnSpell(41,1,true,false,false);//Sac anim�
      	}
        if(lvl>=3)
      ...
      case CLASS_SRAM:
    	  if(lvl >= 1)
      	{
      		...
      		perso.learnSpell(72,1,true,false,false);//Invisibilit�
      ...
      case CLASS_CRA:
    	  if(lvl >= 1)
      	{
      		...
      		perso.learnSpell(164,1,true,false,false);////Fleche Empoisonn�e(ex Fleche chercheuse)
      	}
        if(lvl>=3)
      ...
      case CLASS_SACRIEUR:
    	  if(lvl >= 1)
      	{
      		...
      		perso.learnSpell(431,1,true,false,false);//Chatiment Forc�
    	  ...
    	  if(lvl >= 1)
        	{
        		...
        		perso.learnSpell(687,1,true,false,false);//Poing enflamm�
        	}
        if(lvl>=3)
