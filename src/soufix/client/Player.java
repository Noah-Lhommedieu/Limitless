...
//Name
  ...
  private long pa=0, pm=0, vitalite=0, sagesse=0, terre=0, feu=0, eau=0, air=0, initiative=0;
...
public ArrayList<Integer> getIsCraftingType()
   ...
   // this.mpExo=mpExo;
    ...
    try
    {
     ...
     try {
      ...
      if(this.curPdv<=0)
      {
    	  //this.sendMessage("PV en dessous ou �gal � 0");
    	  this.curPdv=10;
    	  //this.curPdv=1;
    	  }
      String[] pdvv2 = null;
  ...
  public Player(int id, String name, int groupe, int sexe, int classe, int color1, int color2, int color3, int level, int _size, int _gfxid, HashMap<Long, Long> stats2, String stuff, int pdvPer, byte seeAlign, int mount, int alvl, byte alignement)
  {
    ...
    this._size=_size;
    this.gfxId=_gfxid;
    this.stats=new Stats(stats2,true,this);
    this.changeName=false;
  ...
  public static Player ClonePerso(Player P, int id, Long pdv)
  {
    ...
    stats.put((long) Constant.STATS_ADD_RP_NEU,P.getStats().getEffect(Constant.STATS_ADD_RP_NEU) <= 50  ?P.getStats().getEffect(Constant.STATS_ADD_RP_NEU) : 50);
    stats.put((long)Constant.STATS_ADD_RP_TER,P.getStats().getEffect(Constant.STATS_ADD_RP_TER) <= 50  ?P.getStats().getEffect(Constant.STATS_ADD_RP_TER): 50);
    stats.put((long)Constant.STATS_ADD_RP_FEU,P.getStats().getEffect(Constant.STATS_ADD_RP_FEU) <= 50  ?P.getStats().getEffect(Constant.STATS_ADD_RP_FEU): 50);
    stats.put((long)Constant.STATS_ADD_RP_EAU,P.getStats().getEffect(Constant.STATS_ADD_RP_EAU) <= 50  ?P.getStats().getEffect(Constant.STATS_ADD_RP_EAU): 50);
    stats.put((long)Constant.STATS_ADD_RP_AIR,P.getStats().getEffect(Constant.STATS_ADD_RP_AIR) <= 50  ?P.getStats().getEffect(Constant.STATS_ADD_RP_AIR): 50);
    stats.put((long)Constant.STATS_ADD_AFLEE,P.getStats().getEffect(Constant.STATS_ADD_AFLEE));
    stats.put((long)Constant.STATS_ADD_MFLEE,P.getStats().getEffect(Constant.STATS_ADD_MFLEE));
...
public void setTotal_reculte() {
  ...
  public boolean learnSpell(int spellID, int level, boolean save, boolean send, boolean learn)
  {
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(this,"Vous Avez d�j� ce sort.");
      return false;
    }
    else
    {
  ...
  public void OnJoinGame()
  {
   ...
   // for(int a=1;a<Main.world.getItemSetNumber();a++)
      ...
      else if(object.getTemplate().getId()==10207)
      {
        ...
        if(date!=null)
        {
          ...
          if(System.currentTimeMillis()-Long.parseLong(date)>345600000)
          {
            ...
            this.sendMessage("Votre trousseau a �t� r�initialis�");
          }
        }
      }
    }
    ...
    if(Config.getInstance().fightAsBlocked)
      this.sendServerMessage("Vous ne pouvez d�marrer aucun combat tant que le serveur n'a pas red�marr�.");
  ...
  public long getInitiative()
  {
    if(!useStats)
    {
      ...
      long init=1;
      if(maxPdv!=0)
        init=(long)(coef*((double)curPdv/(double)maxPdv));
      if(init<0)
        init=0;
      return init;
    }
  ...
  public void boostStat(int stat, boolean capital)
  {
    ...
    long cout=Constant.getReqPtsToBoostStatsByClass(this.getClasse(),stat,value);
    if(!capital)
      cout=0;
    if(cout<=_capital)
    {
  ...
  public void boostStatFixedCount(int stat, long countVal)
  {
    ...
    int maxSasa = 3000000;
      ...
      case 11://Vita
        ...
        case 12://Sage
        	...
        	if(this.getStats().get(Constant.STATS_ADD_SAGE) > maxSasa ) { // Si le joueur a le max de sagesse, on lui redonne son capital (no gaspillage)
            	_capital+=countVal;
            	this.getStats().addOneStat(Constant.STATS_ADD_SAGE,-countVal);
            	SocketManager.PACKET_POPUP_DEPART(this, "Vous ne pouvez pas d�passer "+ maxSasa +" de Sagesse \n <b>DOSE UN PEU</b>.");
            	}
          break;
        case 10://Force
      ...
      //int cout = Constant.getReqPtsToBoostStatsByClass(this.getClasse(),stat,value);
        ...
        _capital-=countVal; // On retire le capital car ici, �a donne les stats
  ...
  public boolean addObjet(GameObject newObj, boolean stackIfSimilar)
  {
    for(Entry<Integer, GameObject> entry : objects.entrySet())
    {
      ...
      {
        obj.setQuantity(obj.getQuantity()+newObj.getQuantity(), this);//On ajoute QUA item a la quantit� de l'objet existant
        if(isOnline)
  ...
  public boolean levelUp(boolean send, boolean addXp)
  {
    ...
    this.level+= addLvl; // Modifier �a pour faire de 1 a 1  vers  1 -> lvl attendu
    _capital+= 5 * addLvl;
    _spellPts += 1 * addLvl;
  ...
  private int addlvl() //Calculateur d'exp pour savoir le niveau qu'aura le joueur � la fin, t�l�porte le lvl -> pas it�ratif -> no lag
	{
		int level = 0;
  ...
  public void verifEquiped()
  {
    ...
    if(arme!=null)
    {
      ...
      if(arme.getTemplate().isTwoHanded()&&bouclier!=null)
      {
        ...
        this.sendMessage("Vous ne pouve pas �quip�e une arme � 2 mains avec votre bouclier");
      }
  ...
  public void teleport(short newMapID, int newCellID)
  {
    ...
    if(this.getMount()!=null)
    {
      ...
      {
        this.toogleOnMount();
        SocketManager.GAME_SEND_MESSAGE(this,"Vous ne pouvez plus monter votre monture, elle est �puis�e ... Nourrissez-la ou laissez-la reposer dans un enclos");
      }
    }
    if(this.curCell != null)
  ...
  public void addInBank(int guid, int qua)
  {
    ...
    if(BankObj==null) // Ajout d'un nouvel objet dans la banque
    {
      ...
      {
        PersoObj.setQuantity(newQua, this); //on modifie la quantit� d'item du sac
    ...
    // S'il y avait un item du meme template
    {
      if(newQua<=0) //S'il ne reste pas d'item dans le sac
      {
        ...
        BankObj.setQuantity(BankObj.getQuantity()+PersoObj.getQuantity(), this); //On ajoute la quantit� a l'objet en banque
...
//    }
    ...
    {
      //obj.setPosition(Constant.ITEM_POS_NO_EQUIPED); Fami -> Monture d�s�quip�
  ...
  public void toggleWings(char c)
  {
    ...
    switch(c)
    {
      ...
      case '-':
        if(Config.getInstance().HEROIC)
        {
          SocketManager.GAME_SEND_MESSAGE(this,"Vous ne pouvez pas d�sactiver vos ailes sur un serveur h�ro�que.");
          break;
        }
        else
        {
  ...
  public void usePrisme(String packet)
  {
    ...
    for(Prism Prisme : Main.world.AllPrisme())
    {
      if(Prisme.getMap()==Short.valueOf(packet.substring(2)))
      {
        ...
        {
          SocketManager.GAME_SEND_MESSAGE(this,"Ce prisme est actuellement en combat et ne peut pas �tre t�l�port� vers.");
          return;
        }
  ...
  public void itemchek (){
	...
	public static void SpellMax(Player player)
    {
        ...
        if (changed) {
            ...
            SocketManager.GAME_SEND_MESSAGE(player, "Tous vos sorts ont �t� mont�s au niveau <b>6</b>." , "009900");
    }
    }
